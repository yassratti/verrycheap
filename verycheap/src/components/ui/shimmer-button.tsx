  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] border font-bold border-white/10 text-md px-9 py-3 whitespace-nowrap text-white [background:var(--bg)]",
