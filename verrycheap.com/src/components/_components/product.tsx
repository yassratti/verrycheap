...
export default function Product({
  ...
  const isNetflix = title.toLowerCase().includes("netflix");
  ...
  return (
    <div className="w-full mt-10 pt-6 flex flex-col items-center justify-center relative z-20">
      ...
      <div className="text-center space-y-3 mb-20 px-5 w-full">
      ...
      {isNetflix ? (
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
              ...
              <div className="w-full">
                ...
                <Button
                  className="text-lg w-full mt-3 px-8 py-6 bg-blue-600 cursor-pointer hover:bg-blue-700 text-white font-semibold"
              ...
              {variants && variants.length > 0 && (
                <div className="w-full mt-2 space-y-4">
                  {variants.map((variant, index) => {
                    const isPremium = variant.title.toLowerCase().includes("premium");
                    return (
                      <div key={index} className="w-full border-t pt-4">
                        ...
                        <Button
                          ...
                          className={`text-lg cursor-pointer w-full mt-3 px-8 py-6 font-semibold ${
                            isPremium
        ...
        /* Other products: Original layout */
        <>
              ...
              <div className="w-full mt-6 space-y-4">
                {variants.map((variant, index) => (
                  <div key={index} className="w-full border-t pt-4">
                    ...
                    <Button
                      className="text-lg cursor-pointer w-full mt-3 px-8 py-6 bg-blue-600 hover:bg-blue-700 text-white font-semibold"
                      onClick={() => window.open(variant.purchaseLink, "_blank")}
                    >
                      Purchase Now
                    </Button>
